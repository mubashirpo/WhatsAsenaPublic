...
Asena.addCommand({pattern: 'tta (.*)', fromMe: true, dontAddCommandList: false }, (async (message, match) => {
    if(match[1] === undefined || match[1] == "")
        return;
...
Asena.addCommand({pattern: 'tta (.*)', fromMe: false, dontAddCommandList: false }, (async (message, match) => {
    if(match[1] === undefined || match[1] == "")
        return;
